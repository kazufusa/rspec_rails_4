...
describe ContactsController do
  describe 'administrator access' do
    ...
    describe 'POST #create' do
      before :each do
        @phones = Array.new(3){attributes_for(:phone)}
      end

      context 'with valid attributes' do
        it 'saves the new contact in the database' do
          expect{post :create, contact: attributes_for(:contact, phones_attributes: @phones)}.
      ...
      context 'with invalid attributes' do
        it 'does not save the new contact in the database' do
          expect{post :create, contact: attributes_for(:invalid_contact)}. 
    ...
    describe 'PATCH #update' do
      ...
      context "with valid attributes" do
        it 'rocates the replaced @contact' do
